...
export interface BeanstalkSiloFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BOOKKEEPER_ADDRESS"
      | "DEFAULT_ADMIN_ROLE"
...
export interface BeanstalkSiloFactory extends BaseContract {
  connect(runner?: ContractRunner | null): BeanstalkSiloFactory;
  waitForDeployment(): Promise<this>;

  interface: BeanstalkSiloFactoryInterface;
