...
export interface IAssessorInterface extends Interface {
...
export interface IAssessor extends BaseContract {
  connect(runner?: ContractRunner | null): IAssessor;
  waitForDeployment(): Promise<this>;

  interface: IAssessorInterface;
