...
//         uint256 phrsAmount = (usdcAmount * 1e18) / (uint256(getLatestUsdcPrice()) * phrsUsdPrice);
...
//         uint256 phrsAmount = (beanAmount * 1e18) / (getLatestBeanPrice() * phrsUsdPrice);
//         require(phrs.balanceOf(address(this)) >= phrsAmount, "Not enough PHRS in contract");
...
//         uint256 phrsAmount = (msg.value * 1e18) / (uint256(getLatestEthPrice()) * phrsUsdPrice);
//         require(phrs.balanceOf(address(this)) >= phrsAmount, "Not enough PHRS in contract");
